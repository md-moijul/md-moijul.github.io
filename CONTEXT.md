...
- **Feature Component**: A domain-specific component (e.g., `ProjectCard`, `ExperienceCard`) that understands the shape of domain models. These live in a dedicated `src/components/features/` folder, keeping `ui/` purely generic and sections purely structural.
